...
(function(APP) {
	...
	_.extend(APP.templates, {
		...
		header: {
			title:
				"<span class='app-title'><%= title %></span>\n\
		    	 ...
		    	 <span><small class='module-version'></small></span>",
            ...
            "<div class='modal-dialog'>\n\
                <div class='modal-content'>\n\
                    ...
                    <div class='modal-body'>\n\
                        <p><strong><span class='feedback-text'>Initializing</span><strong><strong> ... please wait<strong></p>\n\
						<div class='progress'>\n\
		...
		footer: {
			copyright:
				"<span class='app-copyright'>©&nbsp;<%= copyrightYear %>&nbsp;<%= institute.code %></span>",
